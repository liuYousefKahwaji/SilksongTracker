...
- Of 1,419 map pins, 1,188 have save rules, 166 are reference locations, and **65 objectives still need verified tracking**. “Only left” excludes unverified and informational pins.
...
Tests (after map setup): `python -m unittest discover -s tests -v`. The current suite has 25 tests; passing tests do not prove full in-game coverage.
